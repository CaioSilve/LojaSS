...
public class CadClieFrame extends javax.swing.JInternalFrame {
     ...
     String cidade;
     String bairro;
    /** Creates new form CadClieFrame */
    public CadClieFrame() {
        initComponents();
        
        con_bd = new conexao();
        con_bd.conecta();
        con_bd.executaSQL("select * from tab_clientes");
        ...
        preencherTabela("select * from tab_clientes order by nome_clie");
    ...
    public void limpar(){
        ...
        TxtTele1.setEnabled(false);
        TxtTele2.setEnabled(false);
        TxtCep.setEnabled(false);
        TxtEmail.setEnabled(false);
        TxtDataNasc.setEnabled(false);
        CboEsta.setEnabled(false);
    ...
    public void habilitar(){
        ...
        TxtTele1.setEnabled(true);
        TxtTele2.setEnabled(true);
        TxtCep.setEnabled(true);
        TxtEmail.setEnabled(true);
        TxtDataNasc.setEnabled(true);
        CboEsta.setEnabled(true);
    ...
    private void initComponents() {
        ...
        try{
            javax.swing.text.MaskFormatter format_textField3 = new javax.swing.text.MaskFormatter("(##) #####-####");
            TxtTele2 = new javax.swing.JFormattedTextField(format_textField3);
        }catch (Exception e){}
        ...
        CboEsta = new javax.swing.JComboBox<>();
        ...
        try{
            javax.swing.text.MaskFormatter format_textField3 = new javax.swing.text.MaskFormatter("(##) ####-####");
            TxtTele1 = new javax.swing.JFormattedTextField(format_textField3);
        }catch (Exception e){}
        ...
        TxtTele2.setFont(new java.awt.Font("Verdana", 0, 14)); // NOI18N
        TxtTele2.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)));
        ...
        CboEsta.setFont(new java.awt.Font("Verdana", 0, 14)); // NOI18N
        CboEsta.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "SP", "RJ", "MG", "MT", "PR", "BR" }));
        CboEsta.setBorder(null);
        ...
        jLabel12.setText("Clientes já cadastrados:");
        ...
        TxtTele1.setFont(new java.awt.Font("Verdana", 0, 14)); // NOI18N
        TxtTele1.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)));
                    ...
                    .addGroup(layout.createSequentialGroup()
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addGap(4, 4, 4)
                                .addComponent(TxtEnde, javax.swing.GroupLayout.PREFERRED_SIZE, 170, javax.swing.GroupLayout.PREFERRED_SIZE))
                            .addGroup(layout.createSequentialGroup()
                                .addGap(20, 20, 20)
                                .addComponent(jLabel5, javax.swing.GroupLayout.PREFERRED_SIZE, 69, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGap(4, 4, 4)
                                .addComponent(TxtNume, javax.swing.GroupLayout.PREFERRED_SIZE, 93, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGap(4, 4, 4)
                                ...
                                .addGap(18, 18, 18)
                                .addComponent(TxtCida, javax.swing.GroupLayout.PREFERRED_SIZE, 239, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGap(10, 10, 10)
                                .addComponent(jLabel3)
                                .addGap(20, 20, 20)
                                .addComponent(CboEsta, javax.swing.GroupLayout.PREFERRED_SIZE, 55, javax.swing.GroupLayout.PREFERRED_SIZE))
                            .addGroup(layout.createSequentialGroup()
                                .addGap(20, 20, 20)
                                .addComponent(jLabel8)
                                .addGap(0, 0, 0)
                                .addComponent(TxtTele1, javax.swing.GroupLayout.PREFERRED_SIZE, 135, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGap(5, 5, 5)
                                .addComponent(jLabel9)
                                .addGap(10, 10, 10)
                                .addComponent(TxtTele2, javax.swing.GroupLayout.PREFERRED_SIZE, 141, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGap(9, 9, 9)
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(CboEsta, javax.swing.GroupLayout.PREFERRED_SIZE, 24, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addGroup(layout.createSequentialGroup()
                        .addGap(1, 1, 1)
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(TxtTele1, javax.swing.GroupLayout.PREFERRED_SIZE, 24, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(jLabel9, javax.swing.GroupLayout.PREFERRED_SIZE, 22, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(TxtTele2, javax.swing.GroupLayout.PREFERRED_SIZE, 24, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void BtnExcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnExcluirActionPerformed
        if(TxtCpf.getText().trim().equals("")){
            ...
            int fechar;
            fechar = 0;
            fechar = JOptionPane.showConfirmDialog(null, "Deseja realmente exlcuir este cliente?", "Exlcuir", JOptionPane.YES_NO_OPTION, 2);
              if (fechar == 0){ //se for sim
                getObjCliente().setCpf(TxtCpf.getText());

                String insert_sql = "delete from tab_clientes where cpf_clie = '" + objCliente.getCpf() + "'";
                try {
                    con_bd.statement.executeUpdate(insert_sql);
                    JOptionPane.showMessageDialog(null, "Cliente Deletado com sucesso !!!");
                    preencherTabela("select * from tab_clientes");
                    limpar();
    ...
    private void BtnAlterarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnAlterarActionPerformed
         try {
            getObjCliente().setNome(TxtNome.getText());
            getObjCliente().setEnde(TxtEnde.getText());
            getObjCliente().setCpf(TxtCpf.getText());
            getObjCliente().setNume(TxtNume.getText());
            getObjCliente().setCep(TxtCep.getText());
            getObjCliente().setCida(TxtCida.getText());
            getObjCliente().setEsta(CboEsta.getSelectedItem().toString());
            getObjCliente().setTele1(TxtTele1.getText());
            getObjCliente().setTele2(TxtTele2.getText());
            getObjCliente().setData_Nasc(TxtDataNasc.getText());
            getObjCliente().setEmai(TxtEmail.getText());
        } catch(Exception ex){
            JOptionPane.showMessageDialog(null, "Ocorreu algum erro, " + ex);
        }

        String insert_sql = "update tab_clientes set nome_clie = '" + objCliente.getNome() + "', ende_clie = '" + objCliente.getEnde() + "', nume_ende_clie = '" + objCliente.getNume() + "', cida_clie = '" + objCliente.getCida() + "', tele1_clie = '" + objCliente.getTele1() + "', tele2_clie = '" + objCliente.getTele2() + "', data_nasc_clie = '" + objCliente.getData_Nasc() + "', cep_clie = '" + objCliente.getCep() + "', emai_clie = '" + objCliente.getEmai() + "', esta_clie = '" + objCliente.getEsta() + "' where cpf_clie = '" + objCliente.getCpf() + "'";
        try {
            con_bd.statement.executeUpdate(insert_sql);
    ...
    private void BtnCadastrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnCadastrarActionPerformed
        ...
        String insert_sql = "insert into tab_clientes (cpf_clie, nome_clie, ende_clie, nume_ende_clie, cida_clie, tele1_clie, tele2_clie, data_nasc_clie, cep_clie, emai_clie, esta_clie) values ('" + objCliente.getCpf() + "', '" + objCliente.getNome() + "', '" + objCliente.getEnde() +"', '" + objCliente.getNume() +"', '"+ objCliente.getCida() +"', '" + objCliente.getTele1() + "', '" + objCliente.getTele2() + "', '" + objCliente.getData_Nasc() + "', '" + objCliente.getCep() + "', '" + objCliente.getEmai() + "', '" + objCliente.getEsta() + "')";
        try {
            con_bd.statement.executeUpdate(insert_sql);
    ...
    private void TxtCpfKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_TxtCpfKeyPressed
        ...
        if (TxtCpf.getText().trim().length() >= 14){
            ...
            {
                getObjCliente().setCpf(TxtCpf.getText());
                String pesquisa = "select * from tab_clientes where cpf_clie = '" + objCliente.getCpf() + "'";
                con_bd.executaSQL(pesquisa);
                if (con_bd.resultset.first())
                {
                    JOptionPane.showMessageDialog(null, "Cliente já cadastrado");
                    CboEsta.setSelectedItem(con_bd.resultset.getString("esta_clie"));
                    TxtNome.setText(con_bd.resultset.getString("nome_clie"));
                    TxtEnde.setText(con_bd.resultset.getString("ende_clie"));
                    TxtNume.setText(con_bd.resultset.getString("nume_ende_clie"));
                    TxtCida.setText(con_bd.resultset.getString("cida_clie"));
                    TxtTele1.setText(con_bd.resultset.getString("tele1_clie"));
                    TxtTele2.setText(con_bd.resultset.getString("tele2_clie"));
                    TxtDataNasc.setText(con_bd.resultset.getString("Data_Nasc_clie"));
                    TxtCep.setText(con_bd.resultset.getString("cep_clie"));
                    TxtEmail.setText(con_bd.resultset.getString("emai_clie"));
            ...
            {
                JOptionPane.showMessageDialog(null, "Erro de Acesso na Tabela de Cliente" + "\n" + erro + "\n" + "Contate o Suporte Técnico");
            }
            habilitar();
        }
    ...
    public void preencherTabela(String sql){
        ...
        con_bd.executaSQL(sql);
         ...
         try {
             ...
             do{
                 dados.add(new Object[]{con_bd.resultset.getString("cpf_clie"), con_bd.resultset.getString("nome_clie"), con_bd.resultset.getString("cep_clie"), con_bd.resultset.getString("tele1_clie"), con_bd.resultset.getString("emai_clie")});
         ...
         //Conluna CEP
         TblClie.getColumnModel().getColumn(2).setPreferredWidth(62);
         ...
         //Conluna Email
          TblClie.getColumnModel().getColumn(4).setPreferredWidth(269);
    ...
    private javax.swing.JComboBox<String> CboEsta;
